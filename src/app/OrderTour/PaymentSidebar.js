...
function PaymentSidebar(props) {
    ...
    const adultTotal = orderData.adult_number * tour_price_detail_info.price_sell_adult;
    ...
    let childTotal = 0;
    if (orderData && orderData.data_child) {
                ...
                <div className={'p-1 tour-info-body'}>
                    ...
                    {orderData&&orderData.data_child.map((item,index)=> (
                        <div className={'d-flex justify-content-between'}>
                            ...
                            <div>
                                {item.child_number} x  {tour_price_detail_info.data_child_price[index].child_price_formated}đ
                            </div>
                        </div>
                    ))}
