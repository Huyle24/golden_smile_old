                ...
                <Row key={index}>
                    ...
                    <span className="d-flex align-items-center text-primary mb-2">
                        ...
                        <div className="d-flex align-items-center">
                            ...
                            <span className="px-4 py-2 border bg-white rounded-2"><FaHeart
                                className="me-1 text-danger"/>126</span>
                        </div>
                    </Col>
                    ...
                    <Col lg="6">
                        <div className="d-flex justify-content-end">
                            <div className="d-flex flex-column me-3">
                                ...
                                <p><span
                                    className="text-danger fs-4 fw-bold">{GlobalJs.format_currency(item.price)}₫</span>/
                                    khách</p>
                            </div>
                            <div className="d-flex flex-column">
                                <Link href='/CartBackup' className="text-white">

                                    <Button variant="danger" className="mb-1 px-4 d-flex align-items-center"
                                ...
                                <Button className="bg-white text-black border-black mb-1" onClick={handleShow}>Liên hệ
                                    tư vấn</Button>
